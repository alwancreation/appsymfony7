...
function setTransferDriver(id){
    $('#booking_id').val(id);
    return false;
}
function setTransferVehicle(id){
    $('#vehicle_booking_id').val(id);
    return false;
}
function setExportAction(url){
    $('#form-filter-report').attr('action',url);
    return false;
}

function copyToClip(id){
    /* Get the text field */
    var copyText = document.getElementById("booking_data_"+id);
